...
/* Wiring Guide */
//Serial MP3 Player A     |  Arduino UNO R3// Works with nano also
//              RX              |   7
//              TX              |   8
//              VCC            |   5V
//              GND            |   GND

// make sure to use external power supply 
// do not power from arduino nano pins ...  or limit the volume
